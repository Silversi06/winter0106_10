...
public class SimpleNotepad extends JFrame implements ActionListener {
	...
	public void makeToolbar() {
		...
		btnNew = new JButton(new ImageIcon("images/새문서.png"));
		btnOpen = new JButton(new ImageIcon("images/열기.png"));
		btnSave = new JButton(new ImageIcon("images/저장.png"));
